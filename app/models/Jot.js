...
export class Jot {
  ...
  get jotDisplay() {
    return `<div role="button" onclick="app.JotController.selectCreateJot('${this.name}')" class="selectable p-3 mt-4 mb-3 d-flex justify-content-between">
    ...
    return `
          ...
          <div class="col-md-8 jumble-card shadow mt-5">
            <div class="row d-flex">
              ...
              <div class="col-md-3">
                <form onsubmit="app.JotController.deleteJot()"><button class="btn btn-outline-danger">Delete</button>
                </form>
            ...
            <form class="text-center mt-3">
              <div class="form-group mt-2">
                <textarea class="form-control textarea bg-dark" style="color:aquamarine" id="" name="body"
                  placeholder="Start Jotting" rows="25" required>${this.body}</textarea>
              </div>
              <div class="p-2">
